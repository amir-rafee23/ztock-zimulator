...
let ping (ticker : string) () =  
  let uri = (Uri.of_string ("https://yahoo-finance15.p.rapidapi.com/api/yahoo/qu/quote/" ^ ticker)) in

  let headers = Header.init ()
    |> fun h -> Header.add h "X-RapidAPI-Key" "9c784e7fd4msh27e0c693f9db50bp194ed1jsnae17d653ab59"
  ...
  let test () =
    ...
    Printf.printf "The current market price is: %f\n" value
